...
let canalNombre = ["A L I N A - C L O V E R"]
...
let modos = cargarModos();
    ...
    console.log(chalk.green("\n✅ Iniciando Alina Clover Bot...\n"));
    
    // ✅ Mostrar opciones de conexión bien presentadas
    console.log(chalk.yellow("Elija Una Opción Para Vincular a Alina-Bot\n"));
    ...
    if (!fs.existsSync("./sessions/creds.json")) {
        method = await question(chalk.magenta("Ingrese El Número Ej: 584162967777"));
    ...
    async function startBot() {
        try {
            ...
            const socketSettings = {
                ...
                browser: method === "1" ? ["Alina-Clover", "Safari", "1.0.0"] : ["Ubuntu", "Chrome", "20.0.04"],
            };
...
setupConnection(sock)
            ...
            if (!fs.existsSync("./sessions/creds.json") && method === "2") {
                let phoneNumber = await question("🍂Numero Confirmado..");
                phoneNumber = phoneNumber.replace(/\D/g, "");
                setTimeout(async () => {
                    let code = await sock.requestPairingCode(phoneNumber);
                    console.log(chalk.magenta("🍁Codigo De Vinculación :") + chalk.yellow(code.match(/.{1,4}/g).join("-")));
                }, 2000);
            }
...
if (fs.existsSync(welcomePath)) {
  customWelcomes = JSON.parse(fs.readFileSync(welcomePath, "utf-8"));
    ...
    const welcomeTexts = [
      "彡 𝙒 𝙀 𝙇 𝘾 𝙊 𝙈 𝙀 彡\n\n𝘽𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙤 𝘼 𝙀𝙨𝙩𝙚 𝙂𝙧𝙪𝙥𝙤, 𝙈𝙚 𝙋𝙧𝙚𝙨𝙚𝙣𝙩𝙤, 𝙎𝙤𝙮 𝘼𝙡𝙞𝙣𝙖 𝘾𝙡𝙤𝙫𝙚𝙧, 𝙐𝙣 𝘽𝙤𝙩 𝘿𝙚 𝙒𝙝𝙖𝙩𝙨𝙖𝙥𝙥 𝘾𝙧𝙚𝙖𝙙𝙤 𝙥𝙤𝙧 𝘼𝙣𝙯𝙯 彡 𝘿𝙨𝙠 𝙉𝙢𝙧 +502 38999796 , 𝙀𝙨𝙘𝙧𝙞𝙗𝙚 𝙀𝙡 𝘾𝙤𝙢𝙖𝙣𝙙𝙤.menu 𝙋𝙖𝙧𝙖 𝙑𝙚𝙧 𝙏𝙤𝙙𝙖𝙨 𝙈𝙞𝙨 𝙁𝙪𝙣𝙘𝙞𝙤𝙣𝙚𝙨"
    ];
    const farewellTexts = [
      "𝙇𝙖𝙢𝙚𝙣𝙩𝙖𝙗𝙡𝙚𝙢𝙚𝙣𝙩𝙚 𝙎𝙚 𝙉𝙤𝙨 𝙃𝙖 𝙞𝙙𝙤 𝙐𝙣 𝙈𝙞𝙚𝙢𝙗𝙧𝙤 𝙙𝙚𝙡 𝙂𝙧𝙪𝙥𝙤, 𝙀𝙨𝙥𝙚𝙧𝙤 𝙦𝙪𝙚 𝙇𝙚 𝙫𝙖𝙮𝙖 𝘽𝙞𝙚𝙣 𝙤 𝙇𝙤 𝙖𝙩𝙧𝙤𝙥𝙚𝙡𝙡𝙚 𝙪𝙣 𝙏𝙧𝙚𝙣"
    ];
  ...
  for (const participant of update.participants) {
    ...
    try {
      ...
      try {
        ...
        profilePicUrl = "https://qu.ax/ZTjFR.jpg";
      }
    }
...
try {
  ...
  if (comandosRpg.includes(commandOnly) && !rpgActivo) {
    const mensajesBloqueo = [
      "🚫 Este comando RPG está desactivado en este grupo. Usa .rpgalina on o off.",
      "🛑 El mundo RPG está apagado. Usa .rpgalina on o off.",
      "❌ Comandos RPG no disponibles. Usa .rpgazura on o off.",
      "🚷 Sistema RPG desactivado. Usa .rpgalina on o off."
    ];
